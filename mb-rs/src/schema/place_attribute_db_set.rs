...
impl PlaceAttributeSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<PlaceAttribute> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<PlaceAttribute>> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<PlaceAttribute>> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<PlaceAttribute> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<PlaceAttribute>> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<PlaceAttribute>> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<PlaceAttribute> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<PlaceAttribute>> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<PlaceAttribute>> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_place_id<'e, E: PgExecutor<'e>>(executor: E, place_id: i32) -> Result<Vec<PlaceAttribute>> {
        query_as::<_, PlaceAttribute>(r#"SELECT * FROM "musicbrainz"."place_attribute" WHERE place = $1"#)
            .bind(place_id)
            .fetch_all(executor)
            .await
    }
    pub async fn all_by_place_attribute_type_id<'e, E: PgExecutor<'e>>(executor: E, place_attribute_type_id: i32) -> Result<Vec<PlaceAttribute>> {
    ...
    pub async fn all_by_place_attribute_type_allowed_value_id<'e, E: PgExecutor<'e>>(executor: E, place_attribute_type_allowed_value_id: i32) -> Result<Vec<PlaceAttribute>> {
    ...
    pub async fn update<'e, E: PgExecutor<'e>>(&self, executor: E, place_attribute: PlaceAttribute) -> Result<PlaceAttribute> {
        query_as::<_, PlaceAttribute>(r#"UPDATE "place_attribute" SET "place" = $2, "place_attribute_type" = $3, "place_attribute_type_allowed_value" = $4, "place_attribute_text" = $5 WHERE "id" = 1 RETURNING *;"#)
            .bind(place_attribute.id)
            .bind(place_attribute.place)
            .bind(place_attribute.place_attribute_type)
            .bind(place_attribute.place_attribute_type_allowed_value)
