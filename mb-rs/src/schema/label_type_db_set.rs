...
impl LabelTypeSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<LabelType> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<LabelType>> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<LabelType>> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<LabelType> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<LabelType>> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<LabelType>> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<LabelType> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<LabelType>> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<LabelType>> {
        query_as::<_, LabelType>(r#"SELECT * FROM "musicbrainz"."label_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_label_type_id<'e, E: PgExecutor<'e>>(executor: E, label_type_id: i32) -> Result<Vec<LabelType>> {
    ...
    pub async fn update<'e, E: PgExecutor<'e>>(&self, executor: E, label_type: LabelType) -> Result<LabelType> {
        query_as::<_, LabelType>(r#"UPDATE "label_type" SET "name" = $2, "parent" = $3, "child_order" = $4, "description" = $5, "gid" = $6 WHERE "id" = 1 RETURNING *;"#)
            .bind(label_type.id)
            .bind(label_type.name)
            .bind(label_type.parent)
            .bind(label_type.child_order)
