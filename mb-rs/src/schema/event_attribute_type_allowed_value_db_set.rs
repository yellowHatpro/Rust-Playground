...
impl EventAttributeTypeAllowedValueSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EventAttributeTypeAllowedValue> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EventAttributeTypeAllowedValue>> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EventAttributeTypeAllowedValue>> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EventAttributeTypeAllowedValue> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EventAttributeTypeAllowedValue>> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EventAttributeTypeAllowedValue>> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EventAttributeTypeAllowedValue> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EventAttributeTypeAllowedValue>> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EventAttributeTypeAllowedValue>> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"SELECT * FROM "musicbrainz"."event_attribute_type_allowed_value" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_event_attribute_type_id<'e, E: PgExecutor<'e>>(executor: E, event_attribute_type_id: i32) -> Result<Vec<EventAttributeTypeAllowedValue>> {
    ...
    pub async fn all_by_event_attribute_type_allowed_value_id<'e, E: PgExecutor<'e>>(executor: E, event_attribute_type_allowed_value_id: i32) -> Result<Vec<EventAttributeTypeAllowedValue>> {
    ...
    pub async fn update<'e, E: PgExecutor<'e>>(&self, executor: E, event_attribute_type_allowed_value: EventAttributeTypeAllowedValue) -> Result<EventAttributeTypeAllowedValue> {
        query_as::<_, EventAttributeTypeAllowedValue>(r#"UPDATE "event_attribute_type_allowed_value" SET "event_attribute_type" = $2, "value" = $3, "parent" = $4, "child_order" = $5, "description" = $6, "gid" = $7 WHERE "id" = 1 RETURNING *;"#)
            .bind(event_attribute_type_allowed_value.id)
            .bind(event_attribute_type_allowed_value.event_attribute_type)
            .bind(event_attribute_type_allowed_value.value)
            .bind(event_attribute_type_allowed_value.parent)
