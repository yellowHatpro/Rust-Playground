...
impl ReleaseGroupSecondaryTypeJoinSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ReleaseGroupSecondaryTypeJoin> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ReleaseGroupSecondaryTypeJoin>> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ReleaseGroupSecondaryTypeJoin>> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ReleaseGroupSecondaryTypeJoin> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ReleaseGroupSecondaryTypeJoin>> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ReleaseGroupSecondaryTypeJoin>> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ReleaseGroupSecondaryTypeJoin> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ReleaseGroupSecondaryTypeJoin>> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ReleaseGroupSecondaryTypeJoin>> {
        query_as::<_, ReleaseGroupSecondaryTypeJoin>(r#"SELECT * FROM "musicbrainz"."release_group_secondary_type_join" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_release_group_id<'e, E: PgExecutor<'e>>(executor: E, release_group_id: i32) -> Result<Vec<ReleaseGroupSecondaryTypeJoin>> {
    ...
    pub async fn all_by_release_group_secondary_type_id<'e, E: PgExecutor<'e>>(executor: E, release_group_secondary_type_id: i32) -> Result<Vec<ReleaseGroupSecondaryTypeJoin>> {
