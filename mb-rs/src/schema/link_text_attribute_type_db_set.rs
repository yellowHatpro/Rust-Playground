...
impl LinkTextAttributeTypeSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<LinkTextAttributeType> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<LinkTextAttributeType>> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<LinkTextAttributeType>> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<LinkTextAttributeType> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<LinkTextAttributeType>> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<LinkTextAttributeType>> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<LinkTextAttributeType> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<LinkTextAttributeType>> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<LinkTextAttributeType>> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_link_attribute_type_id<'e, E: PgExecutor<'e>>(executor: E, link_attribute_type_id: i32) -> Result<Vec<LinkTextAttributeType>> {
        query_as::<_, LinkTextAttributeType>(r#"SELECT * FROM "musicbrainz"."link_text_attribute_type" WHERE attribute_type = $1"#)
