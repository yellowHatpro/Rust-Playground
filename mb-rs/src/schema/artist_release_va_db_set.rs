...
impl ArtistReleaseVaSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ArtistReleaseVa> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ArtistReleaseVa>> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ArtistReleaseVa>> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ArtistReleaseVa> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ArtistReleaseVa>> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ArtistReleaseVa>> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ArtistReleaseVa> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ArtistReleaseVa>> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ArtistReleaseVa>> {
        query_as::<_, ArtistReleaseVa>(r#"SELECT * FROM "musicbrainz"."artist_release_va" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_artist_id<'e, E: PgExecutor<'e>>(executor: E, artist_id: i32) -> Result<Vec<ArtistReleaseVa>> {
    ...
    pub async fn all_by_release_id<'e, E: PgExecutor<'e>>(executor: E, release_id: i32) -> Result<Vec<ArtistReleaseVa>> {
    ...
    pub async fn update<'e, E: PgExecutor<'e>>(&self, executor: E, artist_release_va: ArtistReleaseVa) -> Result<ArtistReleaseVa> {
        query_as::<_, ArtistReleaseVa>(r#"UPDATE "artist_release_va" SET "is_track_artist" = $1, "artist" = $2, "artist" = $3, "artist" = $4, "artist" = $5, "artist" = $6, "artist" = $7, "artist" = $8, "artist" = $9, "artist" = $10, "first_release_date" = $11, "catalog_numbers" = $12, "country_code" = $13, "barcode" = $14, "sort_character" = $15, "release" = $16, "release" = $17, "release" = $18, "release" = $19, "release" = $20, "release" = $21, "release" = $22, "release" = $23, "release" = $24 WHERE  RETURNING *;"#)
            .bind(artist_release_va.is_track_artist)
            .bind(artist_release_va.artist)
            .bind(artist_release_va.artist)
            .bind(artist_release_va.artist)
