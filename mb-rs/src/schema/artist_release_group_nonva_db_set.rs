...
impl ArtistReleaseGroupNonvaSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ArtistReleaseGroupNonva> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ArtistReleaseGroupNonva>> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ArtistReleaseGroupNonva>> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ArtistReleaseGroupNonva> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ArtistReleaseGroupNonva>> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ArtistReleaseGroupNonva>> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<ArtistReleaseGroupNonva> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<ArtistReleaseGroupNonva>> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<ArtistReleaseGroupNonva>> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"SELECT * FROM "musicbrainz"."artist_release_group_nonva" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_artist_id<'e, E: PgExecutor<'e>>(executor: E, artist_id: i32) -> Result<Vec<ArtistReleaseGroupNonva>> {
    ...
    pub async fn all_by_release_group_id<'e, E: PgExecutor<'e>>(executor: E, release_group_id: i32) -> Result<Vec<ArtistReleaseGroupNonva>> {
    ...
    pub async fn update<'e, E: PgExecutor<'e>>(&self, executor: E, artist_release_group_nonva: ArtistReleaseGroupNonva) -> Result<ArtistReleaseGroupNonva> {
        query_as::<_, ArtistReleaseGroupNonva>(r#"UPDATE "artist_release_group_nonva" SET "is_track_artist" = $1, "artist" = $2, "artist" = $3, "artist" = $4, "artist" = $5, "artist" = $6, "artist" = $7, "artist" = $8, "artist" = $9, "artist" = $10, "unofficial" = $11, "primary_type" = $12, "secondary_types" = $13, "first_release_date" = $14, "sort_character" = $15, "release_group" = $16, "release_group" = $17, "release_group" = $18, "release_group" = $19, "release_group" = $20, "release_group" = $21, "release_group" = $22, "release_group" = $23, "release_group" = $24 WHERE  RETURNING *;"#)
            .bind(artist_release_group_nonva.is_track_artist)
            .bind(artist_release_group_nonva.artist)
            .bind(artist_release_group_nonva.artist)
            .bind(artist_release_group_nonva.artist)
