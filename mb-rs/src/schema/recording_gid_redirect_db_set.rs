...
impl RecordingGidRedirectSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<RecordingGidRedirect> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<RecordingGidRedirect>> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<RecordingGidRedirect>> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<RecordingGidRedirect> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<RecordingGidRedirect>> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<RecordingGidRedirect>> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<RecordingGidRedirect> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<RecordingGidRedirect>> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<RecordingGidRedirect>> {
        query_as::<_, RecordingGidRedirect>(r#"SELECT * FROM "musicbrainz"."recording_gid_redirect" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_recording_id<'e, E: PgExecutor<'e>>(executor: E, recording_id: i32) -> Result<Vec<RecordingGidRedirect>> {
