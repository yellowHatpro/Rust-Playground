...
impl EventTypeSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EventType> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EventType>> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EventType>> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EventType> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EventType>> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EventType>> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EventType> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EventType>> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EventType>> {
        query_as::<_, EventType>(r#"SELECT * FROM "musicbrainz"."event_type" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_event_type_id<'e, E: PgExecutor<'e>>(executor: E, event_type_id: i32) -> Result<Vec<EventType>> {
    ...
    pub async fn update<'e, E: PgExecutor<'e>>(&self, executor: E, event_type: EventType) -> Result<EventType> {
        query_as::<_, EventType>(r#"UPDATE "event_type" SET "name" = $2, "parent" = $3, "child_order" = $4, "description" = $5, "gid" = $6 WHERE "id" = 1 RETURNING *;"#)
            .bind(event_type.id)
            .bind(event_type.name)
            .bind(event_type.parent)
            .bind(event_type.child_order)
