...
impl EditorSubscribeLabelDeletedSet {
    ...
    pub async fn by_release<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EditorSubscribeLabelDeleted> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_release_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EditorSubscribeLabelDeleted>> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_release_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EditorSubscribeLabelDeleted>> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_position<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EditorSubscribeLabelDeleted> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_position_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EditorSubscribeLabelDeleted>> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_position_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EditorSubscribeLabelDeleted>> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_optional(executor)
            .await
    }

    pub async fn by_medium<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<EditorSubscribeLabelDeleted> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_one(executor)
            .await
    }

    pub async fn many_by_medium_list<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Vec<EditorSubscribeLabelDeleted>> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_all(executor)
            .await
    }

    pub async fn by_medium_optional<'e, E: PgExecutor<'e>>(&self, executor: E, ) -> Result<Option<EditorSubscribeLabelDeleted>> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE "#)
            .fetch_optional(executor)
            .await
    }
    ...
    pub async fn all_by_editor_id<'e, E: PgExecutor<'e>>(executor: E, editor_id: i32) -> Result<Vec<EditorSubscribeLabelDeleted>> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"SELECT * FROM "musicbrainz"."editor_subscribe_label_deleted" WHERE editor = $1"#)
            .bind(editor_id)
            .fetch_all(executor)
            .await
    }
    pub async fn all_by_deleted_entity_gid<'e, E: PgExecutor<'e>>(executor: E, deleted_entity_gid: uuid::Uuid) -> Result<Vec<EditorSubscribeLabelDeleted>> {
    ...
    pub async fn all_by_edit_id<'e, E: PgExecutor<'e>>(executor: E, edit_id: i32) -> Result<Vec<EditorSubscribeLabelDeleted>> {
    ...
    pub async fn update<'e, E: PgExecutor<'e>>(&self, executor: E, editor_subscribe_label_deleted: EditorSubscribeLabelDeleted) -> Result<EditorSubscribeLabelDeleted> {
        query_as::<_, EditorSubscribeLabelDeleted>(r#"UPDATE "editor_subscribe_label_deleted" SET "deleted_by" = $3 WHERE "editor" = 1 AND "gid" = 2 RETURNING *;"#)
            .bind(editor_subscribe_label_deleted.editor)
            .bind(editor_subscribe_label_deleted.gid)
            .bind(editor_subscribe_label_deleted.deleted_by)
            .fetch_one(executor)
